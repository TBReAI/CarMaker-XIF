...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 13.0.1 2024-01-30",
    "libcarmaker.a	CarMaker win64 13.0.1 2024-01-30",
    "libipgdriver.a	IPGDriver win64 13.0.1 2024-01-29",
    "libipgroad.a	IPGRoad win64 13.0.1 2024-01-29",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=130001",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 13.0.1 - Car_Generic",          /* App_Version         */
    "4",          /* App_BuildVersion    */
    "jetbrains",     /* App_CompileUser     */
    "6be5821ad487",         /* App_CompileSystem   */
    "2024-01-30 13:19:37",  /* App_CompileTime */
